...
(function($) {
    ...
    ImagesGrid.prototype.getExtension = function(filename) {
        var parts = filename.split('.');
        return parts[parts.length - 1];
    }

    ImagesGrid.prototype.isImage = function(filename) {
    ...
    ImagesGrid.prototype.isVideo = function(filename) {
        var ext = this.getExtension(filename);
        switch (ext.toLowerCase()) {
        case 'm4v':
        case 'avi':
    ...
    ImagesGridModal.prototype.getExtension = function(filename) {
        var parts = filename.split('.');
        return parts[parts.length - 1];
    }

    ImagesGridModal.prototype.isImage = function(filename) {
        var ext = this.getExtension(filename);
        switch (ext.toLowerCase()) {
        case 'jpg':
        case 'gif':
    ...
    ImagesGridModal.prototype.isVideo = function(filename) {
        var ext = this.getExtension(filename);
        switch (ext.toLowerCase()) {
        case 'm4v':
        case 'avi':
    ...
    ImagesGridModal.prototype.updateImage = function() {
        ...
        var opts = this.opts,
            image = this.getImage(this.imageIndex),
            imageEl = this.$modal.find('.modal-image img, .modal-image video'),
            $elem = '';
    ...
    ImagesGridModal.prototype.showLoader = function() {
        if (this.$modal) {
            this.$modal.find('.modal-image img, .modal-image video').hide();
    ...
    ImagesGridModal.prototype.hideLoader = function() {
        if (this.$modal) {
            this.$modal.find('.modal-image img, .modal-image video').show();
